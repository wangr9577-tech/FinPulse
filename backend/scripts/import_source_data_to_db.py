...
SOURCE_DATA_DIR = settings.BASE_DIR / "data" / "source_data"
if not SOURCE_DATA_DIR.exists():
    SOURCE_DATA_DIR = settings.BASE_DIR / "backend" / "data" / "source_data"

RESULTS_DIR = settings.BASE_DIR / "data" / "results"
if not RESULTS_DIR.exists():
    RESULTS_DIR = settings.BASE_DIR / "backend" / "data" / "results"
