...
from utils import PROCESSED, TZ_BEIJING

SCRIPT_DIR = Path(__file__).resolve().parent

TASKS = [
    ("A0: DR007/SHIBOR", "fetch_dr007"),
    ("A组: 货币/信用 (指标3-6)", "fetch_liquidity_credit"),
    ("B组: 宏观经济 (指标7-12)", "fetch_nbs_macro"),
    ("C组: 估值数据 (指标13-18)", "fetch_valuation"),
    ("D组: 资金流向 (指标19-21)", "fetch_capital_flow"),
    ("E组: 技术指标 (指标22-28)", "fetch_market_technical"),
    ("F组: 情绪数据 (指标29-32)", "fetch_sentiment"),
    ("G组: 期权数据 (指标33-35)", "fetch_options"),
]
